            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="p-4 border rounded">
                        ...
                        <form class="row g-3 pb-2">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-2">
                                   ...
                                   <input class="form-control" type="text" id="invoice_no" name="invoice_no" value="{{ $invoice->invoice_no }}" disabled>
                               </div>
                            </div>
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input class="result form-control" type="text" id="date" name="invoice_date" value="{{ $invoice->date }}">
                            </div>
                        ...
                        <form action="{{ route('invoice.update') }}" method="POST" class="pt-2">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="form-group col-md-12">
                                        <textarea name="note" id="note" rows="1" class="form-control">{{ $invoice->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                          
                            <div class="form-group">
                                <button type="submit" class="btn btn-success" id="storeInvoice">Update Sales</button>
                            </div>
                        </form>
