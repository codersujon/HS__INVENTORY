...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Approve Deliverable Invoice</div>
        <div class="ps-3">
            ...
            <div class="p-4 border rounded">
                <div class="row mb-3 d-flex justify-content-center">
                    ...
                    <div class="col-md-6 text-end">
                        <a href="{{ route('invoice.on.delivery') }}" class="btn btn-primary radius-30">
                            <i class="fadeIn animated bx bx-list-ul"></i> On Delivery Invoice List
                        </a>
                    </div>
                </div>
                ...
                <form action="{{ route('invoice.deliverable.store', $invoice->id) }}" method="POST">
                    @csrf
                    ...
                    <button class="btn btn-success mt-3" type="submit">Save As Delivered</button>
                </form>
            </div>
        </div>
    </div>
